...
namespace RegexStringLibrary
{
	...
	public static class Stex
	{
		...
		{
			string strPush = strOpen + strStack.Push();
			string strPop = strClose + strStack.Pop();
			string strGreedyContents = OrAnyOf(strPush, strPop, Any.Optional());
			string strGreedy = strGreedyContents.Greedy().Rep(0);
